...
// Script to add a user as a guide by email
...
// This script grants guide access to ojharupesh.25@gmail.com

const addGuideByEmail = async (email) => {
    ...
    try {
        ...
        // Step 2: Create/Update document in 'guides' collection
        const psychologistRef = doc(db, 'guides', userId);

        await setDoc(psychologistRef, {
            name: userData.displayName || 'Guide',
            email: email,
        ...
        console.log('✅ Successfully granted guide access!');
        console.log(`User can now access: https://soulthread.in/guide-dashboard`);
        ...
        console.log('✅ Updated user role to guide');
...
addGuideByEmail('ojharupesh.25@gmail.com')
    .then(uid => {
