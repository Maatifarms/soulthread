...
(async () => {
    ...
    const CATEGORIES = [
        { id: 'healing-recovery-stories', name: 'Healing & Recovery Stories', icon: '🌱', color: '#3d8b7f', colorSoft: '#eef6f5', order: 1, description: 'Personal journeys of overcoming emotional well-being challenges, trauma, addiction recovery, grief, and transformation.', aiKeywords: ['recovery', 'healing', 'trauma', 'overcome', 'journey', 'survived', 'getting better', 'guidance helped', 'growth'] },
        { id: 'mind-psychology', name: 'Mind & Psychology', icon: '🧠', color: '#6366f1', colorSoft: '#eef2ff', order: 2, description: 'Insights into emotional well-being conditions, emotional concepts, guidance approaches, and neuroscience.', aiKeywords: ['anxiety', 'depression', 'OCD', 'ADHD', 'guidance', 'psychology', 'cognitive', 'emotional well-being', 'disorder', 'insight'] },
        { id: 'awareness-social-education', name: 'Awareness & Social Education', icon: '📢', color: '#f59e0b', colorSoft: '#fffbeb', order: 3, description: 'Breaking stigma, raising awareness about emotional well-being issues, and educating communities.', aiKeywords: ['stigma', 'awareness', 'emotional well-being day', 'educate', 'society', 'community', 'break the silence', 'normalize'] },
        ...
        { id: 'lgbtq', name: 'LGBTQ+', icon: '🏳️‍🌈', color: '#ec4899', colorSoft: '#fdf2f8', order: 6, description: 'A safe space for LGBTQ+ emotional well-being experiences, identity journeys, coming out stories, and community support.', aiKeywords: ['lgbtq', 'gay', 'lesbian', 'bisexual', 'transgender', 'queer', 'non-binary', 'coming out', 'pride', 'identity'] },
        { id: 'parenthood', name: 'Parenthood', icon: '👨‍👩‍👧', color: '#8b5cf6', colorSoft: '#f5f3ff', order: 7, description: 'Emotional well-being in the context of parenting — postpartum experiences, parenting anxiety, raising emotionally healthy children.', aiKeywords: ['parenting', 'mother', 'father', 'child', 'postpartum', 'family', 'kids', 'baby', 'parental', 'raising children'] },
        { id: 'senior-citizen', name: 'Senior Citizen Love & Issues', icon: '🤍', color: '#64748b', colorSoft: '#f8fafc', order: 8, description: 'Emotional well-being, loneliness, life transitions, grief, and wisdom from and for senior citizens and their caregivers.', aiKeywords: ['elderly', 'senior', 'aging', 'loneliness', 'retirement', 'grandparent', 'caregiver', 'old age', 'life review'] },
