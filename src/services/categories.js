...
export const CATEGORIES = [
    {
        ...
        description: 'Personal journeys of overcoming emotional challenges, difficult life events, grief, and transformation.',
        icon: 'HeartPulse',
        color: '#3d8b7f',
        colorSoft: '#eef6f5',
        order: 1,
        isActive: true,
        aiKeywords: ['healing', 'overcome', 'journey', 'survived', 'getting better', 'growth', 'personal story'],
    },
    {
        id: 'mind-psychology',
        slug: 'mind-psychology',
        name: 'Mind & Psychology',
        description: 'Insights into emotional well-being, personal development, self-reflection, and inner peace.',
        icon: 'Brain',
        color: '#6366f1',
        colorSoft: '#eef2ff',
        order: 2,
        isActive: true,
        aiKeywords: ['stress', 'sadness', 'overwhelmed', 'restless', 'self-reflection', 'psychology', 'cognitive', 'emotional well-being', 'mindset'],
    },
    {
        id: 'awareness-social-education',
        slug: 'awareness-social-education',
        name: 'Awareness & Social Education',
        description: 'Breaking stigma, raising awareness about emotional well-being, and educating communities on social issues.',
        icon: 'Volume2',
        color: '#f59e0b',
        colorSoft: '#fffbeb',
        order: 3,
        isActive: true,
        aiKeywords: ['stigma', 'awareness', 'wellness day', 'educate', 'society', 'community', 'break the silence', 'normalize'],
    },
    {
    ...
    },
    {
        ...
        slug: 'lgbtq',
        name: 'LGBTQ+',
        description: 'A safe space for LGBTQ+ emotional experiences, identity journeys, coming out stories, and community support.',
        icon: 'Rainbow',
        color: '#ec4899',
        colorSoft: '#fdf2f8',
        order: 6,
    ...
    },
    {
        ...
        slug: 'parenthood',
        name: 'Parenthood',
        description: 'Emotional well-being in the context of parenting — postpartum experiences, parenting stress, raising emotionally healthy children, and family dynamics.',
        icon: 'Users',
        color: '#8b5cf6',
        colorSoft: '#f5f3ff',
        order: 7,
    ...
    },
    {
        ...
        description: 'Emotional well-being, loneliness, life transitions, grief, and wisdom from and for senior citizens and their caregivers.',
        icon: 'Heart',
        color: '#64748b',
        colorSoft: '#f8fafc',
        order: 8,
