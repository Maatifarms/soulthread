    ...
    return (
        <div className="auth-page">
            <div className="auth-logo-section">
                ...
                <h1 className="auth-logo-title" style={{ fontSize: '32px' }}>Join Sanctuary</h1>
                <p className="auth-logo-subtitle">Begin your journey to a peaceful mind</p>
            </div>
            ...
            <main className="auth-container">
                ...
                <p className="auth-subtitle">Join our supportive community and find your soul space.</p>
