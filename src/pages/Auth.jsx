                ...
                <div className="w-full max-w-md">
                    <div className="mb-10 text-center lg:text-left mt-12 lg:mt-0">
                        <h2 className="text-4xl font-bold tracking-tight mb-3">
                            {mode === 'signup' ? 'Create your sanctuary.' : 'Reset Password'}
                        </h2>
                        <p className="text-gray-500 text-lg">
                            {mode === 'signup' ? 'Join thousands on the path to better mental health.' : 'We will send you instructions to reset your password.'}
                        </p>
                    </div>
